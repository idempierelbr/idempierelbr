...
public class X_LBR_NFSeWS extends PO implements I_LBR_NFSeWS, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_NFSeWS (Properties ctx, int LBR_NFSeWS_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NFSeWS_ID, trxName, virtualColumns);
      /** if (LBR_NFSeWS_ID == 0)
        {
			setLBR_NFSConfig_ID (0);
			setLBR_NFSeWS_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_NFSeWS (Properties ctx, String LBR_NFSeWS_UU, String trxName)
    {
      super (ctx, LBR_NFSeWS_UU, trxName);
      /** if (LBR_NFSeWS_UU == null)
        {
			setLBR_NFSConfig_ID (0);
			setLBR_NFSeWS_ID (0);
			setLBR_NFeEnv (null);
    ...
    /** Standard Constructor */
    public X_LBR_NFSeWS (Properties ctx, String LBR_NFSeWS_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NFSeWS_UU, trxName, virtualColumns);
      /** if (LBR_NFSeWS_UU == null)
        {
			setLBR_NFSConfig_ID (0);
			setLBR_NFSeWS_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NFSeWS[")
	...
	{
		return (I_LBR_NFSConfig)MTable.get(getCtx(), I_LBR_NFSConfig.Table_ID)
