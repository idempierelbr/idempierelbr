...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+1 AS DefaultValue FROM LBR_DI_Addition WHERE LBR_DI_ID=@LBR_DI_ID@
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LBR_DI_Addition[")
    ...
    {
		return (I_LBR_DI)MTable.get(getCtx(), I_LBR_DI.Table_Name)
