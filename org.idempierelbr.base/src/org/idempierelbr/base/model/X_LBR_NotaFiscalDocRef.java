...
@org.adempiere.base.Model(table="LBR_NotaFiscalDocRef")
public class X_LBR_NotaFiscalDocRef extends PO implements I_LBR_NotaFiscalDocRef, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalDocRef (Properties ctx, int LBR_NotaFiscalDocRef_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalDocRef_ID, trxName, virtualColumns);
      /** if (LBR_NotaFiscalDocRef_ID == 0)
        {
			setLBR_NFeDocRefType (null);
			setLBR_NotaFiscalDocRef_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalDocRef (Properties ctx, String LBR_NotaFiscalDocRef_UU, String trxName)
    {
      super (ctx, LBR_NotaFiscalDocRef_UU, trxName);
      /** if (LBR_NotaFiscalDocRef_UU == null)
        {
			setLBR_NFeDocRefType (null);
			setLBR_NotaFiscalDocRef_ID (0);
			setLBR_NotaFiscal_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalDocRef (Properties ctx, String LBR_NotaFiscalDocRef_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalDocRef_UU, trxName, virtualColumns);
      /** if (LBR_NotaFiscalDocRef_UU == null)
        {
			setLBR_NFeDocRefType (null);
			setLBR_NotaFiscalDocRef_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NotaFiscalDocRef[")
	...
	*/
	...
	/** Set NF Model.
		@param LBR_NFModel Referes to old printed NF
	*/
	...
	*/
	...
	/** Set NFe Doc Ref. Type.
		@param LBR_NFeDocRefType NFe Referenced Document Type
	*/
