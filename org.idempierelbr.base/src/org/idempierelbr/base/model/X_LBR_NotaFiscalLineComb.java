...
@org.adempiere.base.Model(table="LBR_NotaFiscalLineComb")
public class X_LBR_NotaFiscalLineComb extends PO implements I_LBR_NotaFiscalLineComb, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalLineComb (Properties ctx, int LBR_NotaFiscalLineComb_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalLineComb_ID, trxName, virtualColumns);
      /** if (LBR_NotaFiscalLineComb_ID == 0)
        {
			setC_Region_ID (0);
			setLBR_CodANP (null);
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalLineComb (Properties ctx, String LBR_NotaFiscalLineComb_UU, String trxName)
    {
      super (ctx, LBR_NotaFiscalLineComb_UU, trxName);
      /** if (LBR_NotaFiscalLineComb_UU == null)
        {
			setC_Region_ID (0);
			setLBR_CodANP (null);
			setLBR_NotaFiscalLineComb_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalLineComb (Properties ctx, String LBR_NotaFiscalLineComb_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalLineComb_UU, trxName, virtualColumns);
      /** if (LBR_NotaFiscalLineComb_UU == null)
        {
			setC_Region_ID (0);
			setLBR_CodANP (null);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NotaFiscalLineComb[")
	...
	*/
	...
	/** Set CODIF Authorisation Code.
		@param LBR_CODIF CODIF Authorisation Code
	*/
	...
	/** Set ANP Code.
		@param LBR_CodANP Product Code issued by the brazilian National Petrol Agency to fuels and lubricants.
	*/
	...
	*/
	...
	/** Set Brazilian Fiscal Invoice (Nota Fiscal) Line Comb.
		@param LBR_NotaFiscalLineComb_ID Brazilian Fiscal Invoice (Nota Fiscal) Line Comb Identifier
	*/
	...
	/** Set Brazilian Fiscal Invoice (Nota Fiscal) Line Comb.
		@param LBR_NotaFiscalLineComb_UU Brazilian Fiscal Invoice (Nota Fiscal) Line Comb Identifier
	*/
	...
	*/
	...
	/** Set Natural Gas Mix Percent.
		@param LBR_pMixGN Natural gas mix percent in a LPG product.
	*/
	...
	/** Set Amount of fuel at room temperature.
		@param LBR_qTemp Amount of fuel sold at room temperature
	*/
