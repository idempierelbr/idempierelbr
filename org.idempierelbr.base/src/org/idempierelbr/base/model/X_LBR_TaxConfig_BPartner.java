...
@org.adempiere.base.Model(table="LBR_TaxConfig_BPartner")
public class X_LBR_TaxConfig_BPartner extends PO implements I_LBR_TaxConfig_BPartner, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_BPartner (Properties ctx, int LBR_TaxConfig_BPartner_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_BPartner_ID, trxName, virtualColumns);
      /** if (LBR_TaxConfig_BPartner_ID == 0)
        {
			setC_BPartner_ID (0);
			setLBR_TaxConfig_BPartner_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_BPartner (Properties ctx, String LBR_TaxConfig_BPartner_UU, String trxName)
    {
      super (ctx, LBR_TaxConfig_BPartner_UU, trxName);
      /** if (LBR_TaxConfig_BPartner_UU == null)
        {
			setC_BPartner_ID (0);
			setLBR_TaxConfig_BPartner_ID (0);
			setLBR_TaxConfiguration_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_BPartner (Properties ctx, String LBR_TaxConfig_BPartner_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_BPartner_UU, trxName, virtualColumns);
      /** if (LBR_TaxConfig_BPartner_UU == null)
        {
			setC_BPartner_ID (0);
			setLBR_TaxConfig_BPartner_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_TaxConfig_BPartner[")
	...
	*/
	...
	/** Set Business Partner Exception.
		@param LBR_TaxConfig_BPartner_ID Identifies a Business Partner Exception
	*/
