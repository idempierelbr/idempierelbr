...
@org.adempiere.base.Model(table="LBR_NotaFiscalPay")
public class X_LBR_NotaFiscalPay extends PO implements I_LBR_NotaFiscalPay, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalPay (Properties ctx, int LBR_NotaFiscalPay_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalPay_ID, trxName, virtualColumns);
      /** if (LBR_NotaFiscalPay_ID == 0)
        {
			setLBR_NotaFiscalPay_ID (0);
			setLBR_NotaFiscal_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalPay (Properties ctx, String LBR_NotaFiscalPay_UU, String trxName)
    {
      super (ctx, LBR_NotaFiscalPay_UU, trxName);
      /** if (LBR_NotaFiscalPay_UU == null)
        {
			setLBR_NotaFiscalPay_ID (0);
			setLBR_NotaFiscal_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalPay (Properties ctx, String LBR_NotaFiscalPay_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalPay_UU, trxName, virtualColumns);
      /** if (LBR_NotaFiscalPay_UU == null)
        {
			setLBR_NotaFiscalPay_ID (0);
			setLBR_NotaFiscal_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NotaFiscalPay[")
