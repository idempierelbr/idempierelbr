...
@org.adempiere.base.Model(table="LBR_TaxAssessmentLine")
public class X_LBR_TaxAssessmentLine extends PO implements I_LBR_TaxAssessmentLine, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_TaxAssessmentLine (Properties ctx, int LBR_TaxAssessmentLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxAssessmentLine_ID, trxName, virtualColumns);
      /** if (LBR_TaxAssessmentLine_ID == 0)
        {
			setAmt (Env.ZERO);
			setLBR_TaxAssessmentLine_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxAssessmentLine (Properties ctx, String LBR_TaxAssessmentLine_UU, String trxName)
    {
      super (ctx, LBR_TaxAssessmentLine_UU, trxName);
      /** if (LBR_TaxAssessmentLine_UU == null)
        {
			setAmt (Env.ZERO);
			setLBR_TaxAssessmentLine_ID (0);
			setLBR_TaxAssessment_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxAssessmentLine (Properties ctx, String LBR_TaxAssessmentLine_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxAssessmentLine_UU, trxName, virtualColumns);
      /** if (LBR_TaxAssessmentLine_UU == null)
        {
			setAmt (Env.ZERO);
			setLBR_TaxAssessmentLine_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_TaxAssessmentLine[")
	...
	*/
	...
	/** LBR_Cod_Aj_Apur AD_Reference_ID=800016 */
	public static final int LBR_COD_AJ_APUR_AD_Reference_ID=800016;
	...
	*/
	...
	{
		return (I_LBR_TaxAssessment)MTable.get(getCtx(), I_LBR_TaxAssessment.Table_ID)
	...
	*/
	...
	/** Type AD_Reference_ID=800015 */
	public static final int TYPE_AD_Reference_ID=800015;
	/** Other Debits = 0 */
