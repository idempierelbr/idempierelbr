...
@org.adempiere.base.Model(table="LBR_TaxConfig_BPGroup")
public class X_LBR_TaxConfig_BPGroup extends PO implements I_LBR_TaxConfig_BPGroup, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_BPGroup (Properties ctx, int LBR_TaxConfig_BPGroup_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_BPGroup_ID, trxName, virtualColumns);
      /** if (LBR_TaxConfig_BPGroup_ID == 0)
        {
			setLBR_FiscalGroup_BPartner_ID (0);
			setLBR_TaxConfig_BPGroup_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_BPGroup (Properties ctx, String LBR_TaxConfig_BPGroup_UU, String trxName)
    {
      super (ctx, LBR_TaxConfig_BPGroup_UU, trxName);
      /** if (LBR_TaxConfig_BPGroup_UU == null)
        {
			setLBR_FiscalGroup_BPartner_ID (0);
			setLBR_TaxConfig_BPGroup_ID (0);
			setLBR_TaxConfiguration_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_BPGroup (Properties ctx, String LBR_TaxConfig_BPGroup_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_BPGroup_UU, trxName, virtualColumns);
      /** if (LBR_TaxConfig_BPGroup_UU == null)
        {
			setLBR_FiscalGroup_BPartner_ID (0);
			setLBR_TaxConfig_BPGroup_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_TaxConfig_BPGroup[")
	...
	*/
	...
	/** Set Business Partner Group Exception.
		@param LBR_TaxConfig_BPGroup_ID Identifies a Business Partner Group Exception
	*/
