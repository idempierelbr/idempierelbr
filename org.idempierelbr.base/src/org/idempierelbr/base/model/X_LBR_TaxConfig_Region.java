...
@org.adempiere.base.Model(table="LBR_TaxConfig_Region")
public class X_LBR_TaxConfig_Region extends PO implements I_LBR_TaxConfig_Region, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_Region (Properties ctx, int LBR_TaxConfig_Region_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_Region_ID, trxName, virtualColumns);
      /** if (LBR_TaxConfig_Region_ID == 0)
        {
			setC_Region_ID (0);
			setLBR_TaxConfig_Region_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_Region (Properties ctx, String LBR_TaxConfig_Region_UU, String trxName)
    {
      super (ctx, LBR_TaxConfig_Region_UU, trxName);
      /** if (LBR_TaxConfig_Region_UU == null)
        {
			setC_Region_ID (0);
			setLBR_TaxConfig_Region_ID (0);
			setLBR_TaxConfiguration_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_Region (Properties ctx, String LBR_TaxConfig_Region_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_Region_UU, trxName, virtualColumns);
      /** if (LBR_TaxConfig_Region_UU == null)
        {
			setC_Region_ID (0);
			setLBR_TaxConfig_Region_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_TaxConfig_Region[")
	...
	*/
	...
	/** Set Region Exception.
		@param LBR_TaxConfig_Region_ID Identifies a Region Exception
	*/
