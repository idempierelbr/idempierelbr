...
@org.adempiere.base.Model(table="LBR_NotaFiscalTransp")
...
// 0
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalTransp (Properties ctx, int LBR_NotaFiscalTransp_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalTransp_ID, trxName, virtualColumns);
      /** if (LBR_NotaFiscalTransp_ID == 0)
        {
			setLBR_IsICMSTaxExempt (false);
// N
...
// 0
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalTransp (Properties ctx, String LBR_NotaFiscalTransp_UU, String trxName)
    {
      super (ctx, LBR_NotaFiscalTransp_UU, trxName);
      /** if (LBR_NotaFiscalTransp_UU == null)
        {
			setLBR_IsICMSTaxExempt (false);
// N
			setLBR_NFeModShipping (null);
// 0
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalTransp (Properties ctx, String LBR_NotaFiscalTransp_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalTransp_UU, trxName, virtualColumns);
      /** if (LBR_NotaFiscalTransp_UU == null)
        {
			setLBR_IsICMSTaxExempt (false);
// N
...
// 0
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NotaFiscalTransp[")
