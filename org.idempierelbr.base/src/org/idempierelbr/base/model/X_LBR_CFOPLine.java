...
@org.adempiere.base.Model(table="LBR_CFOPLine")
...
// N
    ...
    /** Standard Constructor */
    public X_LBR_CFOPLine (Properties ctx, int LBR_CFOPLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_CFOPLine_ID, trxName, virtualColumns);
      /** if (LBR_CFOPLine_ID == 0)
        {
			setC_DocType_ID (0);
			setIsManufactured (null);
...
// N
    ...
    /** Standard Constructor */
    public X_LBR_CFOPLine (Properties ctx, String LBR_CFOPLine_UU, String trxName)
    {
      super (ctx, LBR_CFOPLine_UU, trxName);
      /** if (LBR_CFOPLine_UU == null)
        {
			setC_DocType_ID (0);
			setIsManufactured (null);
// N
...
// N
    ...
    /** Standard Constructor */
    public X_LBR_CFOPLine (Properties ctx, String LBR_CFOPLine_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_CFOPLine_UU, trxName, virtualColumns);
      /** if (LBR_CFOPLine_UU == null)
        {
			setC_DocType_ID (0);
			setIsManufactured (null);
...
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_CFOPLine[")
	...
	*/
	...
	/** Set CFOP Line.
		@param LBR_CFOPLine_ID Identifies the CFOP Line
	*/
