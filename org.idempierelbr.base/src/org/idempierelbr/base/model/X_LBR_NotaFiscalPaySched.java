...
@org.adempiere.base.Model(table="LBR_NotaFiscalPaySched")
public class X_LBR_NotaFiscalPaySched extends PO implements I_LBR_NotaFiscalPaySched, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalPaySched (Properties ctx, int LBR_NotaFiscalPaySched_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalPaySched_ID, trxName, virtualColumns);
      /** if (LBR_NotaFiscalPaySched_ID == 0)
        {
			setLBR_NotaFiscalPaySched_ID (0);
			setLBR_NotaFiscalPay_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalPaySched (Properties ctx, String LBR_NotaFiscalPaySched_UU, String trxName)
    {
      super (ctx, LBR_NotaFiscalPaySched_UU, trxName);
      /** if (LBR_NotaFiscalPaySched_UU == null)
        {
			setLBR_NotaFiscalPaySched_ID (0);
			setLBR_NotaFiscalPay_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalPaySched (Properties ctx, String LBR_NotaFiscalPaySched_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalPaySched_UU, trxName, virtualColumns);
      /** if (LBR_NotaFiscalPaySched_UU == null)
        {
			setLBR_NotaFiscalPaySched_ID (0);
			setLBR_NotaFiscalPay_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NotaFiscalPaySched[")
	...
	*/
	...
	{
		return (I_LBR_NotaFiscalPay)MTable.get(getCtx(), I_LBR_NotaFiscalPay.Table_ID)
