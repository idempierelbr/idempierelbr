...
@org.adempiere.base.Model(table="LBR_TaxConfig_Product")
public class X_LBR_TaxConfig_Product extends PO implements I_LBR_TaxConfig_Product, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_Product (Properties ctx, int LBR_TaxConfig_Product_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_Product_ID, trxName, virtualColumns);
      /** if (LBR_TaxConfig_Product_ID == 0)
        {
			setLBR_TaxConfig_Product_ID (0);
			setLBR_TaxConfiguration_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_Product (Properties ctx, String LBR_TaxConfig_Product_UU, String trxName)
    {
      super (ctx, LBR_TaxConfig_Product_UU, trxName);
      /** if (LBR_TaxConfig_Product_UU == null)
        {
			setLBR_TaxConfig_Product_ID (0);
			setLBR_TaxConfiguration_ID (0);
			setLBR_Tax_ID (null);
    ...
    /** Standard Constructor */
    public X_LBR_TaxConfig_Product (Properties ctx, String LBR_TaxConfig_Product_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxConfig_Product_UU, trxName, virtualColumns);
      /** if (LBR_TaxConfig_Product_UU == null)
        {
			setLBR_TaxConfig_Product_ID (0);
			setLBR_TaxConfiguration_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_TaxConfig_Product[")
	...
	*/
	...
	/** Set Product Exception.
		@param LBR_TaxConfig_Product_ID Indicates a Product Exception
	*/
