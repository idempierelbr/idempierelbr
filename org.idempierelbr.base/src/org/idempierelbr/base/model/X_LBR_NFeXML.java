...
// N
	...
	*/
	...
	/** LBR_DFeStatus AD_Reference_ID=800076 */
	public static final int LBR_DFESTATUS_AD_Reference_ID=800076;
	/** Ignorado = IGNORED */
	public static final String LBR_DFESTATUS_Ignorado = "IGNORED";
	/** Importado = IMPORTED */
	public static final String LBR_DFESTATUS_Importado = "IMPORTED";
	/** Novo = NEW */
	public static final String LBR_DFESTATUS_Novo = "NEW";
	/** Pronto para importar = READY */
	public static final String LBR_DFESTATUS_ProntoParaImportar = "READY";
	/** Aguardando XML completo = WAIT */
	public static final String LBR_DFESTATUS_AguardandoXMLCompleto = "WAIT";
	/** Set Situação do DF-e.
		@param LBR_DFeStatus Situação do DF-e
	*/
	public void setLBR_DFeStatus (String LBR_DFeStatus)
	{

		set_Value (COLUMNNAME_LBR_DFeStatus, LBR_DFeStatus);
	}

	/** Get Situação do DF-e.
		@return Situação do DF-e	  */
	public String getLBR_DFeStatus()
	{
		return (String)get_Value(COLUMNNAME_LBR_DFeStatus);
	}

	/** LBR_DFeType AD_Reference_ID=800075 */
	public static final int LBR_DFETYPE_AD_Reference_ID=800075;
	/** Conhecimento de Transporte = CTE */
	public static final String LBR_DFETYPE_ConhecimentoDeTransporte = "CTE";
	/** Evento = EVT */
	public static final String LBR_DFETYPE_Evento = "EVT";
	/** NF-e = NFE */
	public static final String LBR_DFETYPE_NF_E = "NFE";
	/** Set Tipo de DF-e.
		@param LBR_DFeType Tipo de DF-e
	*/
	...
	/** Set CNPJ do Emitente.
		@param LBR_EmitCNPJ CNPJ do Emitente
	*/
	public void setLBR_EmitCNPJ (String LBR_EmitCNPJ)
	{
		set_Value (COLUMNNAME_LBR_EmitCNPJ, LBR_EmitCNPJ);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_LBR_EmitCNPJ);
	}

	/** Set Razão Social do Emitente.
		@param LBR_EmitName Razão Social do Emitente
	*/
	public void setLBR_EmitName (String LBR_EmitName)
	{
		set_Value (COLUMNNAME_LBR_EmitName, LBR_EmitName);
	}

	/** Get Razão Social do Emitente.
		@return Razão Social do Emitente	  */
	public String getLBR_EmitName()
	{
		return (String)get_Value(COLUMNNAME_LBR_EmitName);
	}

	/** Set XML Completo.
		@param LBR_IsXMLComplete XML Completo
	*/
	public void setLBR_IsXMLComplete (boolean LBR_IsXMLComplete)
	{
		set_Value (COLUMNNAME_LBR_IsXMLComplete, Boolean.valueOf(LBR_IsXMLComplete));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_LBR_IsXMLComplete);
		if (oo != null)
		{
