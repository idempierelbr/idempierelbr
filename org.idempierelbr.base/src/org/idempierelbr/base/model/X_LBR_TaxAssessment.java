...
@org.adempiere.base.Model(table="LBR_TaxAssessment")
...
// 0
    ...
    /** Standard Constructor */
    public X_LBR_TaxAssessment (Properties ctx, int LBR_TaxAssessment_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxAssessment_ID, trxName, virtualColumns);
      /** if (LBR_TaxAssessment_ID == 0)
        {
			setC_Period_ID (0);
			setCumulatedAmt (Env.ZERO);
...
// 0
    ...
    /** Standard Constructor */
    public X_LBR_TaxAssessment (Properties ctx, String LBR_TaxAssessment_UU, String trxName)
    {
      super (ctx, LBR_TaxAssessment_UU, trxName);
      /** if (LBR_TaxAssessment_UU == null)
        {
			setC_Period_ID (0);
			setCumulatedAmt (Env.ZERO);
			setLBR_SaldoCredorTransportar (Env.ZERO);
...
// 0
    ...
    /** Standard Constructor */
    public X_LBR_TaxAssessment (Properties ctx, String LBR_TaxAssessment_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_TaxAssessment_UU, trxName, virtualColumns);
      /** if (LBR_TaxAssessment_UU == null)
        {
			setC_Period_ID (0);
			setCumulatedAmt (Env.ZERO);
...
// 0
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_TaxAssessment[")
	...
	*/
	...
	/** LBR_Cod_OR AD_Reference_ID=800013 */
	public static final int LBR_COD_OR_AD_Reference_ID=800013;
	/** ICMS = 000 */
	...
	*/
	...
	/** Set Revenue Code.
		@param LBR_Cod_Rec Revenue Code specific to state of the federation
	*/
	...
	/** LBR_Ind_Proc AD_Reference_ID=800014 */
	public static final int LBR_IND_PROC_AD_Reference_ID=800014;
	/** SEFAZ = 0 */
	...
	*/
	...
	/** Set Process Number.
		@param LBR_Num_Proc Process Number or infraction notice
	*/
	...
	/** Set Process Description.
		@param LBR_Proc Short description of the process of this record
	*/
	...
	*/
	...
	/** Set Complementary Description.
		@param LBR_Txt_Compl Complementary description of the obligation
	*/
