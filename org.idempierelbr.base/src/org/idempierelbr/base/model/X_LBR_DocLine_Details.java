...
@org.adempiere.base.Model(table="LBR_DocLine_Details")
...
// Y
    ...
    /** Standard Constructor */
    public X_LBR_DocLine_Details (Properties ctx, int LBR_DocLine_Details_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_DocLine_Details_ID, trxName, virtualColumns);
      /** if (LBR_DocLine_Details_ID == 0)
        {
			setLBR_IsGrossAmtInTotal (true);
// Y
    ...
    /** Standard Constructor */
    public X_LBR_DocLine_Details (Properties ctx, String LBR_DocLine_Details_UU, String trxName)
    {
      super (ctx, LBR_DocLine_Details_UU, trxName);
      /** if (LBR_DocLine_Details_UU == null)
        {
			setLBR_IsGrossAmtInTotal (true);
// Y
        } */
    ...
    /** Standard Constructor */
    public X_LBR_DocLine_Details (Properties ctx, String LBR_DocLine_Details_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_DocLine_Details_UU, trxName, virtualColumns);
      /** if (LBR_DocLine_Details_UU == null)
        {
			setLBR_IsGrossAmtInTotal (true);
// Y
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_DocLine_Details[")
	...
	*/
	...
	/** Set Doc Line Details.
		@param LBR_DocLine_Details_UU Doc Line Details
	*/
	...
	/** Set EX TIPI.
		@param LBR_EXTIPI NCM Exception
	*/
	...
	/** Set FCI Control Number.
		@param LBR_FCIControlNo Import Content Sheet (FCI) Control Number
	*/
	...
	/** Set Gross Amount.
		@param LBR_GrossAmt Gross Amount
	*/
	...
	/** Set Gross Amount is in Grand Total.
		@param LBR_IsGrossAmtInTotal This Gross Amount is in Grand Total
	*/
	...
	*/
	...
	{
		if (LBR_NFS_ID < 1)
			set_Value (COLUMNNAME_LBR_NFS_ID, null);
		else
			set_Value (COLUMNNAME_LBR_NFS_ID, Integer.valueOf(LBR_NFS_ID));
	}
	...
	/** Set NF-e Specific Product.
		@param LBR_NFeSpecificProduct Specific Product in a NF-e
	*/
	...
	*/
	...
	{
		return (I_LBR_CFOP)MTable.get(getCtx(), I_LBR_CFOP.Table_ID)
			.getPO(getLBR_OwnCFOP_ID(), get_TrxName());
	}

	/** Set Declarant CFOP Code.
		@param LBR_OwnCFOP_ID CFOP code from the point of view of the declarant
	*/
	public void setLBR_OwnCFOP_ID (int LBR_OwnCFOP_ID)
	{
		if (LBR_OwnCFOP_ID < 1)
			set_Value (COLUMNNAME_LBR_OwnCFOP_ID, null);
		else
			set_Value (COLUMNNAME_LBR_OwnCFOP_ID, Integer.valueOf(LBR_OwnCFOP_ID));
	}

	/** Get Declarant CFOP Code.
		@return CFOP code from the point of view of the declarant
	  */
	public int getLBR_OwnCFOP_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_LBR_OwnCFOP_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Order Line Reference.
		@param LBR_POReferenceLine Transaction Line Reference Number (Sales Order Line, Purchase Order Line) of your Business Partner
	*/
	...
	/** Set Taxable Price.
		@param LBR_PriceTax Taxable Price
	*/
	...
	*/
	...
	/** Set Taxation Type.
		@param LBR_TaxationType Taxation type used to calculate taxes
	*/
	...
	*/
	...
	/** Set Taxable UPC/EAN.
		@param LBR_UPCTax Taxable Bar Code (Universal Product Code or its superset European Article Number)
	*/
	...
	*/
	...
	/** Set Tax Line Total.
		@param TaxLineTotal Tax Line Total Amount
	*/
