...
@org.adempiere.base.Model(table="LBR_NFS")
...
// B
    ...
    /** Standard Constructor */
    public X_LBR_NFS (Properties ctx, int LBR_NFS_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NFS_ID, trxName, virtualColumns);
      /** if (LBR_NFS_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_BPartner_Location_ID (0);
...
// B
    ...
    /** Standard Constructor */
    public X_LBR_NFS (Properties ctx, String LBR_NFS_UU, String trxName)
    {
      super (ctx, LBR_NFS_UU, trxName);
      /** if (LBR_NFS_UU == null)
        {
			setC_BPartner_ID (0);
			setC_BPartner_Location_ID (0);
...
// B
    ...
    /** Standard Constructor */
    public X_LBR_NFS (Properties ctx, String LBR_NFS_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NFS_UU, trxName, virtualColumns);
      /** if (LBR_NFS_UU == null)
        {
			setC_BPartner_ID (0);
			setC_BPartner_Location_ID (0);
...
// B
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NFS[")
	...
	*/
	...
	/** Set Mensagens de Retorno.
		@param LBR_MensagensRetorno Mensagens de Retorno (erros)
	*/
