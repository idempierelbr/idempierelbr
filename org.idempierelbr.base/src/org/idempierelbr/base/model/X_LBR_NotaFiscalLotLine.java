...
@org.adempiere.base.Model(table="LBR_NotaFiscalLotLine")
public class X_LBR_NotaFiscalLotLine extends PO implements I_LBR_NotaFiscalLotLine, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalLotLine (Properties ctx, int LBR_NotaFiscalLotLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalLotLine_ID, trxName, virtualColumns);
      /** if (LBR_NotaFiscalLotLine_ID == 0)
        {
			setLBR_NotaFiscalLot_ID (0);
			setLBR_NotaFiscal_ID (0);
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalLotLine (Properties ctx, String LBR_NotaFiscalLotLine_UU, String trxName)
    {
      super (ctx, LBR_NotaFiscalLotLine_UU, trxName);
      /** if (LBR_NotaFiscalLotLine_UU == null)
        {
			setLBR_NotaFiscalLot_ID (0);
			setLBR_NotaFiscal_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalLotLine (Properties ctx, String LBR_NotaFiscalLotLine_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalLotLine_UU, trxName, virtualColumns);
      /** if (LBR_NotaFiscalLotLine_UU == null)
        {
			setLBR_NotaFiscalLot_ID (0);
			setLBR_NotaFiscal_ID (0);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NotaFiscalLotLine[")
	...
	*/
	...
	/** Set NF-e Lot Line.
		@param LBR_NotaFiscalLotLine_ID Identifies a NF-e Lot Line
	*/
	...
	/** Set NF-e Lot Line.
		@param LBR_NotaFiscalLotLine_UU Identifies a NF-e Lot Line
	*/
	...
	{
		return (I_LBR_NotaFiscalLot)MTable.get(getCtx(), I_LBR_NotaFiscalLot.Table_ID)
