...
public class MLBRNotaFiscal extends X_LBR_NotaFiscal implements DocAction, DocOptions
{
	...
	public static final String IMPORTED_FILE_PREFIX = "GenNFFromXML_";
	...
	/**	Tax Lines					*/
	public MLBRNotaFiscalTax[] 	m_taxes = null;
	/**	Process Message 			*/
	public String		m_processMsg = null;
	
	public static Integer GENERATE_DANFE_PROCESS_ID;
	private final static String JASPER_FILENAME = "DanfeMainPortraitA4.jasper";
	public static final String MODEL_NFE = "55";
