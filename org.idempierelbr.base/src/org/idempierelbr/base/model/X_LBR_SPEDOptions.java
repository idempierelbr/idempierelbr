...
@org.adempiere.base.Model(table="LBR_SPEDOptions")
public class X_LBR_SPEDOptions extends PO implements I_LBR_SPEDOptions, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_SPEDOptions (Properties ctx, int LBR_SPEDOptions_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_SPEDOptions_ID, trxName, virtualColumns);
      /** if (LBR_SPEDOptions_ID == 0)
        {
			setLBR_SPEDOptions_ID (0);
			setLBR_SPED_Activity (null);
    ...
    /** Standard Constructor */
    public X_LBR_SPEDOptions (Properties ctx, String LBR_SPEDOptions_UU, String trxName)
    {
      super (ctx, LBR_SPEDOptions_UU, trxName);
      /** if (LBR_SPEDOptions_UU == null)
        {
			setLBR_SPEDOptions_ID (0);
			setLBR_SPED_Activity (null);
			setLBR_SPED_Profile (null);
    ...
    /** Standard Constructor */
    public X_LBR_SPEDOptions (Properties ctx, String LBR_SPEDOptions_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_SPEDOptions_UU, trxName, virtualColumns);
      /** if (LBR_SPEDOptions_UU == null)
        {
			setLBR_SPEDOptions_ID (0);
			setLBR_SPED_Activity (null);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_SPEDOptions[")
	...
	*/
	...
	/** Set Accountant.
		@param LBR_BP_Accountant_ID Accountant of the Organization
	*/
	...
	/** Set CRC.
		@param LBR_CRC Accountant inscription number on CRC
	*/
	...
	*/
	...
	/** LBR_SPED_Activity AD_Reference_ID=800017 */
	public static final int LBR_SPED_ACTIVITY_AD_Reference_ID=800017;
	...
	*/
	...
	/** LBR_SPED_Profile AD_Reference_ID=800018 */
	public static final int LBR_SPED_PROFILE_AD_Reference_ID=800018;
	/** Profile A = A */
