...
@org.adempiere.base.Model(table="LBR_BoletoDetails")
public class X_LBR_BoletoDetails extends PO implements I_LBR_BoletoDetails, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_LBR_BoletoDetails (Properties ctx, int LBR_BoletoDetails_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_BoletoDetails_ID, trxName, virtualColumns);
      /** if (LBR_BoletoDetails_ID == 0)
        {
			setLBR_Boleto_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_LBR_BoletoDetails (Properties ctx, String LBR_BoletoDetails_UU, String trxName)
    {
      super (ctx, LBR_BoletoDetails_UU, trxName);
      /** if (LBR_BoletoDetails_UU == null)
        {
			setLBR_Boleto_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_LBR_BoletoDetails (Properties ctx, String LBR_BoletoDetails_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_BoletoDetails_UU, trxName, virtualColumns);
      /** if (LBR_BoletoDetails_UU == null)
        {
			setLBR_Boleto_ID (0);
        } */
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_BoletoDetails[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set Boleto Details.
		@param LBR_BoletoDetails_ID Brazilian Bank Collection (Boleto) Details
	*/
	...
	/** Set Boleto Details.
		@param LBR_BoletoDetails_UU Brazilian Bank Collection (Boleto) Details
	*/
