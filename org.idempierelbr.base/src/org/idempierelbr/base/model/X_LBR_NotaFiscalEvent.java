...
@org.adempiere.base.Model(table="LBR_NotaFiscalEvent")
...
// N
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalEvent (Properties ctx, int LBR_NotaFiscalEvent_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalEvent_ID, trxName, virtualColumns);
      /** if (LBR_NotaFiscalEvent_ID == 0)
        {
			setDocumentNo (null);
			setLBR_LotSent (false);
...
// N
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalEvent (Properties ctx, String LBR_NotaFiscalEvent_UU, String trxName)
    {
      super (ctx, LBR_NotaFiscalEvent_UU, trxName);
      /** if (LBR_NotaFiscalEvent_UU == null)
        {
			setDocumentNo (null);
			setLBR_LotSent (false);
// N
...
// N
    ...
    /** Standard Constructor */
    public X_LBR_NotaFiscalEvent (Properties ctx, String LBR_NotaFiscalEvent_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LBR_NotaFiscalEvent_UU, trxName, virtualColumns);
      /** if (LBR_NotaFiscalEvent_UU == null)
        {
			setDocumentNo (null);
			setLBR_LotSent (false);
...
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LBR_NotaFiscalEvent[")
	...
	*/
	...
	/** Set NF-e Event Lot.
		@param LBR_NotaFiscalEvent_UU Identifies a NF-e Event Lot
	*/
