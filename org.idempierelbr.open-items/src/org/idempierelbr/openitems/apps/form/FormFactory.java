...
public class FormFactory implements IFormFactory{
	...
	public ADForm newFormInstance(String formName) {
		if (formName.startsWith("org.idempierelbr.openitems.apps.form")) {
			Object form = null;
			Class<?> clazz = null;
			...
			try {
				...
				log.log(Level.FINE, "Load Form Class Failed in org.idempierelbr.openitems.apps.form", e);
			}
			...
			if (clazz != null) {
				try {
					...
					log.log(Level.FINE, "Form Class Initiate Failed in org.idempierelbr.openitems.apps.form", e);
				}
			}
