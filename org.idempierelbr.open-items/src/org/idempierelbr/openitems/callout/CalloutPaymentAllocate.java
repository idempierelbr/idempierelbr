...
public class CalloutPaymentAllocate implements IColumnCallout {
	...
	public String start(Properties ctx, int WindowNo, GridTab mTab,
		...
		if (mTab.getTableName().equals(MPaymentAllocate.Table_Name))
	...
	public String invoice(Properties ctx, int WindowNo, GridTab mTab,
		...
		Integer C_InvoicePaySchedule_ID = Env.getContextAsInt (ctx, WindowNo, Env.TAB_INFO, "C_InvoicePaySchedule_ID");

		// Check if there is any allocation to invoice only (C_InvoicePaySchedule_ID == null)
