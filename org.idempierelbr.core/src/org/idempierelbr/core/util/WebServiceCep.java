...
/* MÃ©todos e variaveis estaticas, responsÃ¡veis pela busca do CEP */
    /**
     * Mascara para a string url de conexÃ£o, onde <tt>"%s"</tt> é substituido pelo valor
     * do cep. 
     */
