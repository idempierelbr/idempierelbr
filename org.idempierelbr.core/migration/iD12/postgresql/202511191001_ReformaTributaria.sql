...
INSERT INTO t_alter_column values('lbr_notafiscallotline','LBR_NFeStatus','VARCHAR(4)',null,'NULL')
;
...
INSERT INTO t_alter_column values('lbr_notafiscaleventline','LBR_NFeStatus','VARCHAR(4)',null,'NULL')
;
...
-- 19 de nov. de 2025 10:06:51 BRT
ALTER TABLE LBR_TaxDefinition ADD COLUMN C_City_ID NUMERIC(10) DEFAULT NULL 
;
...
-- 19 de nov. de 2025 10:12:39 BRT
ALTER TABLE LBR_TaxDefinition ADD COLUMN LBR_To_City_ID NUMERIC(10) DEFAULT NULL 
;
...
-- 19 de nov. de 2025 10:23:54 BRT
ALTER TABLE LBR_TaxConfig_Region ADD COLUMN C_City_ID NUMERIC(10) DEFAULT NULL 
;
...
-- 19 de nov. de 2025 10:24:55 BRT
ALTER TABLE LBR_TaxConfig_Region ADD COLUMN LBR_To_City_ID NUMERIC(10) DEFAULT NULL 
;
