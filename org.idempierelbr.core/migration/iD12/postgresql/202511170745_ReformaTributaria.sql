...
ALTER TABLE LBR_DocLine_IBSCBS ADD COLUMN LBR_IBS_UF_IsTaxIncluded CHAR(1) DEFAULT 'Y' CHECK (LBR_IBS_UF_IsTaxIncluded IN ('Y','N')) NOT NULL
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD COLUMN LBR_IBS_Mun_IsTaxIncluded CHAR(1) DEFAULT 'Y' CHECK (LBR_IBS_Mun_IsTaxIncluded IN ('Y','N')) NOT NULL
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD COLUMN LBR_CBS_IsTaxIncluded CHAR(1) DEFAULT 'Y' CHECK (LBR_CBS_IsTaxIncluded IN ('Y','N')) NOT NULL
;
...
ALTER TABLE LBR_DocLine_IS ADD COLUMN IsTaxIncluded CHAR(1) DEFAULT 'Y' CHECK (IsTaxIncluded IN ('Y','N')) NOT NULL
;
