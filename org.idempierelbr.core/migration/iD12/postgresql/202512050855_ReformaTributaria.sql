...
-- 5 de dez. de 2025 08:55:05 BRT
ALTER TABLE LBR_TaxLine ADD COLUMN LBR_CST_IBSCBS_ID NUMERIC(10) DEFAULT NULL 
;
...
-- 5 de dez. de 2025 08:55:37 BRT
ALTER TABLE LBR_TaxLine ADD COLUMN LBR_ClassTrib_IBSCBS_ID NUMERIC(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_TaxLine ADD COLUMN LBR_TaxDeferralRate NUMERIC DEFAULT NULL 
;
...
ALTER TABLE LBR_TaxLine ADD COLUMN LBR_TaxRedRate NUMERIC DEFAULT NULL 
;
...
ALTER TABLE LBR_TaxLine ADD COLUMN LBR_TaxRedEfetRate NUMERIC DEFAULT NULL 
;
...
-- 5 de dez. de 2025 09:08:14 BRT
ALTER TABLE LBR_TaxLine ADD COLUMN LBR_CST_IS_ID NUMERIC(10) DEFAULT NULL 
;
...
-- 5 de dez. de 2025 09:08:31 BRT
ALTER TABLE LBR_TaxLine ADD COLUMN LBR_ClassTrib_IS_ID NUMERIC(10) DEFAULT NULL 
;
