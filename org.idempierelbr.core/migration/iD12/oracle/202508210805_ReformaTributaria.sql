...
CREATE TABLE LBR_DocLine_IBSCBS (LBR_DocLine_IBSCBS_ID NUMBER(10) DEFAULT NULL , CONSTRAINT LBR_DocLine_IBSCBS_Key PRIMARY KEY (LBR_DocLine_IBSCBS_ID))
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_DocLine_IBSCBS_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD AD_Client_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD AD_Org_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD Created DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD CreatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD Updated DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD UpdatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- 21 de ago. de 2025 08:11:49 BRT
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_DocLine_Details_ID NUMBER(10) NOT NULL
;
...
CREATE TABLE LBR_CST_IBSCBS (LBR_CST_IBSCBS_ID NUMBER(10) DEFAULT NULL , CONSTRAINT LBR_CST_IBSCBS_Key PRIMARY KEY (LBR_CST_IBSCBS_ID))
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_CST_IBSCBS_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD AD_Client_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD AD_Org_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD Created DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_CST_IBSCBS ADD CreatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD Updated DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_CST_IBSCBS ADD UpdatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
ALTER TABLE LBR_CST_IBSCBS ADD Value VARCHAR2(40 CHAR) NOT NULL
;
...
ALTER TABLE LBR_CST_IBSCBS ADD Name VARCHAR2(255 CHAR) NOT NULL
;
...
ALTER TABLE LBR_CST_IBSCBS ADD Description VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IndgIBSCBS CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IndgIBSCBSMono CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IndgIBSCBSRed CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IndgIBSCBSDif CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IndgIBSCBSTransfCred CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndNFe CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndNFCe CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndCTe CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndCteOS CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndBPe CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndBPeTM CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndNF3e CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndNFCom CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IBSCBS ADD LBR_IBSCBSIndNFSe CHAR(1) DEFAULT NULL 
;
...
CREATE TABLE LBR_ClassTrib_IBSCBS (LBR_ClassTrib_IBSCBS_ID NUMBER(10) DEFAULT NULL , CONSTRAINT LBR_ClassTrib_IBSCBS_Key PRIMARY KEY (LBR_ClassTrib_IBSCBS_ID))
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_ClassTrib_IBSCBS_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD AD_Client_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD AD_Org_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD Created DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD CreatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD Updated DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD UpdatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- Aug 30, 2025, 5:31:29 PM BRT
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_CST_IBSCBS_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD Value VARCHAR2(40 CHAR) NOT NULL
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD Name VARCHAR2(255 CHAR) NOT NULL
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD Description VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
-- Aug 30, 2025, 5:38:26 PM BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800054, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800054)
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS MODIFY Value VARCHAR2(40 CHAR)
;

-- Sep 2, 2025, 7:26:30 AM BRT
ALTER TABLE LBR_ClassTrib_IBSCBS MODIFY Name VARCHAR2(255 CHAR)
;

-- Sep 2, 2025, 7:26:30 AM BRT
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_PRedIBS NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_PRedCBS NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_IndIBSCBSRedBC CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_IndgIBSCBSTribRegular CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_IndgIBSCBSCredPres CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_IndgIBSCBSMono CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_IndgIBSCBSMonoReten CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_IndgIBSCBSMonoRet CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD LBR_IndgIBSCBSMonoDif CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD DateFrom DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD DateTo DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IBSCBS ADD UpdatedDate DATE DEFAULT NULL 
;
...
-- Oct 8, 2025, 7:48:58 AM BRT
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CST_IBSCBS_ID NUMBER(10) NOT NULL
;
...
-- Oct 8, 2025, 7:49:48 AM BRT
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_ClassTrib_IBSCBS_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_DocLine_IBSCBS MODIFY LBR_ClassTrib_IBSCBS_ID NUMBER(10)
;

-- Oct 8, 2025, 8:01:43 AM BRT
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_TaxBaseAmt NUMBER NOT NULL
;
...
ALTER TABLE LBR_DocLine_IBSCBS MODIFY LBR_TaxBaseAmt NUMBER DEFAULT NULL 
;

-- Oct 8, 2025, 8:08:59 AM BRT
ALTER TABLE LBR_DocLine_IBSCBS MODIFY LBR_TaxBaseAmt NULL
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_UF_TaxRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_UF_TaxDeferralRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_UF_TaxDeferralAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_UF_TaxDevAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_UF_TaxRedRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_UF_TaxRedEfetRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_UF_TaxAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_Mun_TaxRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_Mun_TaxDeferralRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_Mun_TaxDeferralAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_Mun_TaxDevAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_Mun_TaxRedRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_Mun_TaxRedEfetRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_IBS_Mun_TaxAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CBS_TaxRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CBS_TaxDeferralRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CBS_TaxDeferralAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CBS_TaxDevAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CBS_TaxRedRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CBS_TaxRedEfetRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IBSCBS ADD LBR_CBS_TaxAmt NUMBER DEFAULT NULL 
;
...
CREATE TABLE LBR_DocLine_IS (LBR_DocLine_IS_ID NUMBER(10) DEFAULT NULL , CONSTRAINT LBR_DocLine_IS_Key PRIMARY KEY (LBR_DocLine_IS_ID))
;
...
ALTER TABLE LBR_DocLine_IS ADD LBR_DocLine_IS_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD AD_Client_ID NUMBER(10) DEFAULT NULL 
;
...
-- Oct 8, 2025, 3:33:55 PM BRT
ALTER TABLE LBR_DocLine_IS ADD AD_Org_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD Created DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_DocLine_IS ADD CreatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD Updated DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_DocLine_IS ADD UpdatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- Oct 8, 2025, 3:36:17 PM BRT
ALTER TABLE LBR_DocLine_IS ADD LBR_DocLine_Details_ID NUMBER(10) NOT NULL
;
...
CREATE TABLE LBR_CST_IS (LBR_CST_IS_ID NUMBER(10) DEFAULT NULL , CONSTRAINT LBR_CST_IS_Key PRIMARY KEY (LBR_CST_IS_ID))
;
...
ALTER TABLE LBR_CST_IS ADD LBR_CST_IS_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IS ADD AD_Client_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IS ADD AD_Org_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IS ADD Created DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_CST_IS ADD CreatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IS ADD Updated DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_CST_IS ADD UpdatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_CST_IS ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
ALTER TABLE LBR_CST_IS ADD Value VARCHAR2(40 CHAR) NOT NULL
;
...
ALTER TABLE LBR_CST_IS ADD Name VARCHAR2(255 CHAR) NOT NULL
;
...
ALTER TABLE LBR_CST_IS ADD Description VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
CREATE TABLE LBR_ClassTrib_IS (LBR_ClassTrib_IS_ID NUMBER(10) DEFAULT NULL , CONSTRAINT LBR_ClassTrib_IS_Key PRIMARY KEY (LBR_ClassTrib_IS_ID))
;
...
ALTER TABLE LBR_ClassTrib_IS ADD LBR_ClassTrib_IS_UU VARCHAR2(36 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD AD_Client_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD AD_Org_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD Created DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_ClassTrib_IS ADD CreatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD Updated DATE DEFAULT SYSDATE
;
...
ALTER TABLE LBR_ClassTrib_IS ADD UpdatedBy NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL
;
...
-- Oct 9, 2025, 9:44:13 AM BRT
ALTER TABLE LBR_ClassTrib_IS ADD LBR_CST_IS_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_ClassTrib_IS ADD Value VARCHAR2(40 CHAR) NOT NULL
;
...
ALTER TABLE LBR_ClassTrib_IS ADD Name VARCHAR2(255 CHAR) NOT NULL
;
...
ALTER TABLE LBR_ClassTrib_IS ADD Description VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD DateFrom DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD DateTo DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_ClassTrib_IS ADD UpdatedDate DATE DEFAULT NULL 
;
...
-- Oct 9, 2025, 10:11:17 AM BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800055, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800055)
;
...
-- Oct 9, 2025, 10:38:45 AM BRT
ALTER TABLE LBR_DocLine_IS ADD LBR_CST_IS_ID NUMBER(10) NOT NULL
;
...
-- Oct 9, 2025, 10:40:02 AM BRT
ALTER TABLE LBR_DocLine_IS ADD LBR_ClassTrib_IS_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_DocLine_IS MODIFY LBR_ClassTrib_IS_ID NUMBER(10)
;

-- Oct 9, 2025, 11:00:35 AM BRT
ALTER TABLE LBR_DocLine_IS ADD LBR_TaxBaseAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD LBR_TaxRate NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD LBR_TaxRateEspec NUMBER DEFAULT NULL 
;
...
-- Oct 9, 2025, 11:01:51 AM BRT
ALTER TABLE LBR_DocLine_IS ADD LBR_UOMTax_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD LBR_QtyTax NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_IS ADD LBR_TaxAmt NUMBER DEFAULT NULL 
;
