...
-- 7 de set. de 2026 10:33:16 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 10, statement_timestamp(), 10,t.AD_Tree_ID, 800074, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800074)
;
...
ALTER TABLE LBR_NFeXML ADD COLUMN IsPrinted CHAR(1) DEFAULT 'N' CHECK (IsPrinted IN ('Y','N')) NOT NULL
;
...
-- 7 de set. de 2026 10:36:30 BRT
ALTER TABLE LBR_NFeXML ADD COLUMN C_Invoice_ID NUMERIC(10) DEFAULT NULL 
;
