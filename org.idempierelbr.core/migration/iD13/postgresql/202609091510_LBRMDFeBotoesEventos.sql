...
ALTER TABLE LBR_MDFe ADD COLUMN LBR_ProcCancelar CHAR(1) DEFAULT NULL;
ALTER TABLE LBR_MDFe ADD COLUMN LBR_ProcEncerrar CHAR(1) DEFAULT NULL;
ALTER TABLE LBR_MDFe ADD COLUMN LBR_ProcIncluirCondutor CHAR(1) DEFAULT NULL;
