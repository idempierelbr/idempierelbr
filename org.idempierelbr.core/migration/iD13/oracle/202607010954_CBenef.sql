...
ALTER TABLE LBR_TaxStatus ADD LBR_CBenef VARCHAR2(10 CHAR) DEFAULT NULL 
;
...
ALTER TABLE M_Product ADD LBR_CBenef VARCHAR2(10 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_ICMS ADD LBR_CBenef VARCHAR2(10 CHAR) DEFAULT NULL 
;
