...
ALTER TABLE LBR_NFeXML ADD LBR_DFeType VARCHAR2(3 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD LBR_DFeStatus VARCHAR2(8 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD LBR_IsXMLComplete CHAR(1) DEFAULT 'N' CHECK (LBR_IsXMLComplete IN ('Y','N')) NOT NULL
;
...
-- 26 de ago. de 2026 14:47:58 BRT
ALTER TABLE LBR_NFeXML ADD LBR_NotaFiscal_ID NUMBER(10) DEFAULT NULL 
;
...
-- 26 de ago. de 2026 14:48:22 BRT
ALTER TABLE LBR_NFeXML ADD C_BPartner_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD LBR_EmitCNPJ VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD LBR_EmitName VARCHAR2(120 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD DocumentNo VARCHAR2(30 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD LBR_NFeSerie VARCHAR2(3 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD DateDoc DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD GrandTotal NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD LBR_NFeModel VARCHAR2(2 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD LBR_NFeStatus VARCHAR2(4 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NFeXML ADD Processed CHAR(1) DEFAULT 'N' CHECK (Processed IN ('Y','N')) NOT NULL
;
...
-- 26 de ago. de 2026 15:22:51 BRT
CREATE TABLE LBR_DFeControl (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_DFeControl_ID NUMBER(10) NOT NULL, LBR_DFeControl_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_DFeControl_Key PRIMARY KEY (LBR_DFeControl_ID), CONSTRAINT LBR_DFeControl_UU_idx UNIQUE (LBR_DFeControl_UU))
;
...
ALTER TABLE LBR_DFeControl ADD LBR_NFeEnv CHAR(1) NOT NULL
;
...
ALTER TABLE LBR_DFeControl ADD LBR_LastNSU VARCHAR2(15 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_DFeControl ADD LBR_MaxNSU VARCHAR2(15 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_DFeControl ADD LBR_LastRequest DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_DFeControl ADD LBR_LastcStat VARCHAR2(4 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_DFeControl ADD LBR_BlockedUntil DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_DFeControl ADD LBR_QueryCount NUMBER(10) DEFAULT NULL 
;
...
-- 26 de ago. de 2026 16:10:03 BRT
ALTER TABLE LBR_NotaFiscal ADD LBR_NFeXML_ID NUMBER(10) DEFAULT NULL 
;
...
-- 26 de ago. de 2026 16:23:50 BRT
CREATE TABLE LBR_NotaFiscalDetPag (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_NotaFiscalDetPag_ID NUMBER(10) NOT NULL, LBR_NotaFiscalDetPag_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_NotaFiscalDetPag_Key PRIMARY KEY (LBR_NotaFiscalDetPag_ID), CONSTRAINT LBR_NotaFiscalDetPag_UU_idx UNIQUE (LBR_NotaFiscalDetPag_UU))
;
...
-- 26 de ago. de 2026 16:25:25 BRT
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_NotaFiscal_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_IndPag CHAR(1) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_TPag VARCHAR2(2 CHAR) NOT NULL
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_xPag VARCHAR2(60 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD PayAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_DatePayment DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_CNPJPag VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
-- 27 de ago. de 2026 10:05:16 BRT
ALTER TABLE LBR_NotaFiscalDetPag ADD C_Region_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_TpIntegra CHAR(1) NOT NULL
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_CardCNPJ VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_CardBrand VARCHAR2(2 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_CardAuth VARCHAR2(128 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_CNPJReceb VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag ADD LBR_IdTermPag VARCHAR2(40 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalDetPag MODIFY LBR_CNPJReceb VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscal ADD LBR_vTroco NUMBER DEFAULT NULL 
;
...
-- 27 de ago. de 2026 11:18:28 BRT
CREATE TABLE LBR_NotaFiscalEventRec (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_NotaFiscalEventRec_ID NUMBER(10) NOT NULL, LBR_NotaFiscalEventRec_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_NotaFiscalEventRec_Key PRIMARY KEY (LBR_NotaFiscalEventRec_ID), CONSTRAINT LBR_NotaFiscalEventRec_UU_idx UNIQUE (LBR_NotaFiscalEventRec_UU))
;
...
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_NFeID VARCHAR2(255 CHAR) DEFAULT NULL 
;
...
-- 27 de ago. de 2026 11:20:31 BRT
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_NotaFiscal_ID NUMBER(10) DEFAULT NULL 
;
...
-- 27 de ago. de 2026 11:20:53 BRT
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_NFeXML_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_EventCode VARCHAR2(6 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_EventSeqNo NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_EventDate DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_EventAuthor VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalEventRec ADD LBR_EventProt VARCHAR2(15 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_NotaFiscalEventRec ADD Description VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800070, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800070)
;
...
-- 27 de ago. de 2026 15:00:00 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800071, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800071)
;
