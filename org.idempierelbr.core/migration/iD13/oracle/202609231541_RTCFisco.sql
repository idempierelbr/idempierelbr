...
-- 23 de set. de 2026 16:19:39 BRT
CREATE TABLE LBR_RTCFiscoConfig (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) DEFAULT 0 NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_RTCFiscoConfig_ID NUMBER(10) NOT NULL, LBR_RTCFiscoConfig_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_RTCFiscoConfig_Key PRIMARY KEY (LBR_RTCFiscoConfig_ID), CONSTRAINT LBR_RTCFiscoConfig_UU_idx UNIQUE (LBR_RTCFiscoConfig_UU))
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_CNPJBase VARCHAR2(8 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_RTCTaxType VARCHAR2(3 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_ClientID VARCHAR2(255 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_ClientSecret VARCHAR2(500 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_WebhookBaseURL VARCHAR2(500 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_WebhookSecret VARCHAR2(128 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_TokenURL VARCHAR2(500 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoConfig ADD LBR_APIBaseURL VARCHAR2(500 CHAR) DEFAULT NULL 
;
...
-- 23 de set. de 2026 16:33:59 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800077, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800077)
;
...
-- 23 de set. de 2026 16:41:41 BRT
CREATE TABLE LBR_RTCFiscoRequest (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) DEFAULT 0 NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_RTCFiscoRequest_ID NUMBER(10) NOT NULL, LBR_RTCFiscoRequest_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_RTCFiscoRequest_Key PRIMARY KEY (LBR_RTCFiscoRequest_ID), CONSTRAINT LBR_RTCFiscoRequest_UU_idx UNIQUE (LBR_RTCFiscoRequest_UU))
;
...
-- 23 de set. de 2026 16:43:59 BRT
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_RTCFiscoConfig_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_RTCTaxType VARCHAR2(3 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_RTCFiscoService VARCHAR2(5 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_Ticket VARCHAR2(60 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_RTCFiscoReqStatus VARCHAR2(10 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoRequest MODIFY LBR_RTCFiscoReqStatus VARCHAR2(10 CHAR)
;

-- 23 de set. de 2026 16:47:42 BRT
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_DateRequested DATE NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_TEASeconds NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_SignedURL VARCHAR2(4000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_SignedURLExpiresAt DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_GeneratedAt DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_ErrorCode VARCHAR2(20 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD LBR_ErrorMsg VARCHAR2(2000 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoRequest ADD Processed CHAR(1) DEFAULT 'N' CHECK (Processed IN ('Y','N')) NOT NULL
;
...
-- 24 de set. de 2026 10:05:50 BRT
CREATE TABLE LBR_RTCFiscoApuracao (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) DEFAULT 0 NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_RTCFiscoApuracao_ID NUMBER(10) NOT NULL, LBR_RTCFiscoApuracao_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_RTCFiscoApuracao_Key PRIMARY KEY (LBR_RTCFiscoApuracao_ID), CONSTRAINT LBR_RTCFiscoApuracao_UU_idx UNIQUE (LBR_RTCFiscoApuracao_UU))
;
...
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_CNPJBase VARCHAR2(8 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_RTCTaxType VARCHAR2(3 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_PA VARCHAR2(7 CHAR) NOT NULL
;
...
-- 24 de set. de 2026 10:08:18 BRT
ALTER TABLE LBR_RTCFiscoApuracao ADD C_Period_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_TotalDebit NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_TotalCredit NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApuracao MODIFY LBR_TotalDebit NUMBER DEFAULT NULL 
;

-- 24 de set. de 2026 10:10:52 BRT
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_TotalPaid NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_Balance NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApuracao ADD LBR_DateUpdated DATE DEFAULT NULL 
;
...
-- 24 de set. de 2026 10:12:13 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800078, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800078)
;
...
-- 24 de set. de 2026 10:17:07 BRT
CREATE TABLE LBR_RTCFiscoApurDoc (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) DEFAULT 0 NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_RTCFiscoApurDoc_ID NUMBER(10) NOT NULL, LBR_RTCFiscoApurDoc_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_RTCFiscoApurDoc_Key PRIMARY KEY (LBR_RTCFiscoApurDoc_ID), CONSTRAINT LBR_RTCFiscoApurDoc_UU_idx UNIQUE (LBR_RTCFiscoApurDoc_UU))
;
...
-- 24 de set. de 2026 10:18:04 BRT
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_RTCFiscoApuracao_ID NUMBER(10) NOT NULL
;
...
-- 24 de set. de 2026 10:18:48 BRT
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_RTCFiscoRequest_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_RTCFiscoDocType CHAR(1) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_Origem NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_Documento NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_DFeChave VARCHAR2(50 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_DateIssued DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_DateRegistered DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_DateUpdated DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_AssessedAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_ExcessAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_NonAppropriableAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_SuspendedAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_PrescribedAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_ToAppropriateAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_AppropriatedAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_NonUsableAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_UsedAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_RestoredAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_CreditBalanceAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_RefundRequestAmt NUMBER DEFAULT NULL 
;
...
-- 24 de set. de 2026 11:44:21 BRT
CREATE TABLE LBR_RTCFiscoPayment (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) DEFAULT 0 NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_RTCFiscoPayment_ID NUMBER(10) NOT NULL, LBR_RTCFiscoPayment_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_RTCFiscoPayment_Key PRIMARY KEY (LBR_RTCFiscoPayment_ID), CONSTRAINT LBR_RTCFiscoPayment_UU_idx UNIQUE (LBR_RTCFiscoPayment_UU))
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_CNPJBase VARCHAR2(8 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_RTCTaxType VARCHAR2(3 CHAR) NOT NULL
;
...
-- 24 de set. de 2026 11:47:48 BRT
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_RTCFiscoRequest_ID NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_RTCFiscoService VARCHAR2(5 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_DARFNo VARCHAR2(30 CHAR) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_PaymentType NUMBER(10) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_DateCollection DATE NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD LBR_NI VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayment ADD TotalAmt NUMBER DEFAULT NULL 
;
...
-- 24 de set. de 2026 11:55:15 BRT
CREATE TABLE LBR_RTCFiscoPayComp (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) DEFAULT 0 NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, LBR_RTCFiscoPayComp_ID NUMBER(10) NOT NULL, LBR_RTCFiscoPayComp_UU VARCHAR2/*UUID*/(36) DEFAULT NULL , Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT LBR_RTCFiscoPayComp_Key PRIMARY KEY (LBR_RTCFiscoPayComp_ID), CONSTRAINT LBR_RTCFiscoPayComp_UU_idx UNIQUE (LBR_RTCFiscoPayComp_UU))
;
...
-- 24 de set. de 2026 11:55:47 BRT
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_RTCFiscoPayment_ID NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD SeqNo NUMBER(10) NOT NULL
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_PA VARCHAR2(7 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD DueDate DATE DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_NI VARCHAR2(14 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_DFeChave VARCHAR2(50 CHAR) DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_PrincipalAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_FineAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_InterestAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoPayComp ADD TotalAmt NUMBER DEFAULT NULL 
;
...
-- 24 de set. de 2026 11:59:55 BRT
ALTER TABLE LBR_RTCFiscoPayComp ADD LBR_RTCFiscoApuracao_ID NUMBER(10) DEFAULT NULL 
;
...
-- 24 de set. de 2026 12:00:48 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800079, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800079)
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_NonEnforceableAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_ExtinguishedAmt NUMBER DEFAULT NULL 
;
...
ALTER TABLE LBR_RTCFiscoApurDoc ADD LBR_DebitBalanceAmt NUMBER DEFAULT NULL 
;
...
-- 24 de set. de 2026 15:45:55 BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', getDate(), 10, getDate(), 10,t.AD_Tree_ID, 800080, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800080)
;
