...
ALTER TABLE C_DocType ADD LBR_FinNFe CHAR(1) DEFAULT '1'
;
...
ALTER TABLE C_DocType ADD LBR_tpNFDebito VARCHAR2(2 CHAR) DEFAULT NULL 
;
...
ALTER TABLE C_DocType ADD LBR_tpNFCredito VARCHAR2(2 CHAR) DEFAULT NULL 
;
