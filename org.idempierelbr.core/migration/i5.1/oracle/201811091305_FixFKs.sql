...
UPDATE AD_Column SET FKConstraintName='LBRLegalMessageLBRTaxConfigBPG',Updated=TO_DATE('2018-11-09 11:56:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000291
;
...
UPDATE AD_Column SET FKConstraintName='LBRLegalMessageLBRTaxConfigPrG',Updated=TO_DATE('2018-11-09 13:08:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000334
;
...
UPDATE AD_Column SET FKConstraintName='LBRLicensePlateRegionLBRNotaFT',Updated=TO_DATE('2018-11-09 13:08:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000701
;
...
UPDATE AD_Column SET FKConstraintName='LBRNotaFiscalLinLBRNotaFiscaLC',Updated=TO_DATE('2018-11-09 13:09:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=800531
;
...
UPDATE AD_Column SET FKConstraintName='LBRNotaFiscalTranspLBRNotaFisT',Updated=TO_DATE('2018-11-09 13:09:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000714
;
...
UPDATE AD_Column SET FKConstraintName='LBRPRevenueReturnAcMProductPCA',Updated=TO_DATE('2018-11-09 13:10:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=801669
;
...
UPDATE AD_Column SET FKConstraintName='LBRTaxConfiguratiLBRTaxConfBPG',Updated=TO_DATE('2018-11-09 13:10:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000295
;
...
UPDATE AD_Column SET FKConstraintName='LBRTaxConfiguratioLBRTaxConfPr',Updated=TO_DATE('2018-11-09 13:11:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000323
;
...
UPDATE AD_Column SET FKConstraintName='LBRTaxConfiguratioLBRTaxConfPG',Updated=TO_DATE('2018-11-09 13:11:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000338
;
...
UPDATE AD_Column SET FKConstraintName='LBRTaxConfigurationLBRTaxConfR',Updated=TO_DATE('2018-11-09 13:11:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1000309
;
