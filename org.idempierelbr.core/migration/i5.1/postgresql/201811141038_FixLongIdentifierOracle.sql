...
UPDATE AD_TableIndex SET Name='lbr_docline_details_invoicelin',Updated=TO_TIMESTAMP('2018-11-14 11:43:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_TableIndex_ID=800077
;
...
UPDATE AD_TableIndex SET Name='lbr_bankaccount_carteira_conve',Updated=TO_TIMESTAMP('2018-11-14 11:44:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_TableIndex_ID=800081
;
...
UPDATE AD_TableIndex SET Name='lbr_taxconfig_bpartner_bpartne',Updated=TO_TIMESTAMP('2018-11-14 11:44:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_TableIndex_ID=800145
;
