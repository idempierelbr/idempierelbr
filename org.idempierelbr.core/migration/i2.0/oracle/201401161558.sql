...
INSERT INTO AD_Table (ImportTable,CopyColumnsFromTable,IsSecurityEnabled,AccessLevel,LoadSeq,AD_Table_ID,IsHighVolume,IsView,IsChangeLog,EntityType,ReplicationType,AD_Table_UU,IsCentrallyMaintained,IsDeleteable,TableName,Description,Name,IsActive,AD_Org_ID,CreatedBy,Updated,UpdatedBy,Created,AD_Client_ID,Processing,DatabaseViewDrop) VALUES ('N','N','N','3',0,1000004,'N','N','N','LBR','L','e2046dd1-4eaa-418b-8ce8-f4b91f548ac3','Y','Y','LBR_FiscalGroup_BPartner','Identifies a Business Partner Fiscal Group','BP Fiscal Group','Y',0,0,TO_DATE('2014-01-16 15:02:43','YYYY-MM-DD HH24:MI:SS'),0,TO_DATE('2014-01-16 15:02:43','YYYY-MM-DD HH24:MI:SS'),0,'N','N')
;

-- Jan 16, 2014 3:02:43 PM BRST
INSERT INTO AD_Sequence (StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,IsAutoSequence,AD_Sequence_ID,Description,Name,IncrementNo,AD_Sequence_UU,Created,CreatedBy,Updated,UpdatedBy,IsActive,StartNo,AD_Client_ID,AD_Org_ID) VALUES ('N',200000,'Y',1000000,'N','Y',1000008,'Table LBR_FiscalGroup_BPartner','LBR_FiscalGroup_BPartner',1,'be7607c7-963f-4348-9c18-27c50bbde419',TO_DATE('2014-01-16 15:02:43','YYYY-MM-DD HH24:MI:SS'),0,TO_DATE('2014-01-16 15:02:43','YYYY-MM-DD HH24:MI:SS'),0,'Y',1000000,0,0)
;

-- Jan 16, 2014 3:03:10 PM BRST
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,DefaultValue,Help,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,AD_Val_Rule_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,1000062,'Y','N','N',0,'N',22,'N','N','N','Y','fd7bb86c-f653-4583-a2c8-4d18d08f5a30','N','AD_Client_ID','Client/Tenant for this installation.','@#AD_Client_ID@','A Client is a company or a legal entity. You cannot share data between Clients. Tenant is a synonym for Client.','Client','N',TO_DATE('2014-01-16 15:03:10','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-16 15:03:10','YYYY-MM-DD HH24:MI:SS'),0,'N','N',0,'N','N',102,19,1000004,129,0,'LBR')
;

-- Jan 16, 2014 3:03:22 PM BRST
UPDATE AD_Column SET FKConstraintName='ADClient_LBRFiscalGroupBPartne', FKConstraintType='N',Updated=TO_DATE('2014-01-16 15:03:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=1000062
;

-- Jan 16, 2014 3:03:22 PM BRST
CREATE TABLE LBR_FiscalGroup_BPartner (AD_Client_ID NUMBER(10) NOT NULL)
;
...
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,DefaultValue,Help,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,AD_Val_Rule_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,1000063,'Y','N','N',0,'N',22,'N','N','N','Y','57cd4553-f42c-4825-a889-f81fba8c71c5','N','AD_Org_ID','Organizational entity within client','@#AD_Org_ID@','An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','Organization','N',TO_DATE('2014-01-16 15:03:51','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-16 15:03:51','YYYY-MM-DD HH24:MI:SS'),0,'N','N',0,'N','N',113,19,1000004,104,0,'LBR')
;

-- Jan 16, 2014 3:03:56 PM BRST
UPDATE AD_Column SET FKConstraintName='ADOrg_LBRFiscalGroupBPartner', FKConstraintType='N',Updated=TO_DATE('2014-01-16 15:03:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=1000063
;

-- Jan 16, 2014 3:03:56 PM BRST
ALTER TABLE LBR_FiscalGroup_BPartner ADD AD_Org_ID NUMBER(10) NOT NULL
;
...
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,1000064,'Y','N','N',0,'N',7,'N','N','N','Y','a88d4c34-ba06-4b2c-8be9-b71ccfaf4337','N','Created','Date this record was created','The Created field indicates the date that this record was created.','Created','N',TO_DATE('2014-01-16 15:04:23','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-16 15:04:23','YYYY-MM-DD HH24:MI:SS'),0,'N','N',0,'N','N',245,16,1000004,0,'LBR')
;

-- Jan 16, 2014 3:04:28 PM BRST
ALTER TABLE LBR_FiscalGroup_BPartner ADD Created DATE NOT NULL
;

-- Jan 16, 2014 3:04:48 PM BRST
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,1000065,'Y','N','N',0,'N',22,'N','N','N','Y','1b087367-ddcb-4eab-a36b-5e46080162f8','N','CreatedBy','User who created this records','The Created By field indicates the user who created this record.','Created By','N',TO_DATE('2014-01-16 15:04:48','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-16 15:04:48','YYYY-MM-DD HH24:MI:SS'),0,'N','N',0,'N','N',246,18,110,1000004,0,'LBR')
;

-- Jan 16, 2014 3:04:53 PM BRST
UPDATE AD_Column SET FKConstraintName='CreatedBy_LBRFiscalGroupBPartn', FKConstraintType='N',Updated=TO_DATE('2014-01-16 15:04:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=1000065
;

-- Jan 16, 2014 3:04:53 PM BRST
ALTER TABLE LBR_FiscalGroup_BPartner ADD CreatedBy NUMBER(10) NOT NULL
;
...
INSERT INTO AD_Element (ColumnName,AD_Element_ID,Name,Description,PrintName,AD_Element_UU,Created,Updated,AD_Org_ID,CreatedBy,UpdatedBy,IsActive,AD_Client_ID,EntityType) VALUES ('LBR_FiscalGroup_BPartner_UU',1000021,'LBR_FiscalGroup_BPartner_UU',NULL,'LBR_FiscalGroup_BPartner_UU','1d53795c-a907-447e-a555-9536fd0872e5',TO_DATE('2014-01-16 15:08:38','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2014-01-16 15:08:38','YYYY-MM-DD HH24:MI:SS'),0,0,0,'Y',0,'LBR')
;

-- Jan 16, 2014 3:08:55 PM BRST
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,IsEncrypted,IsSecure,FKConstraintType,AD_Element_ID,AD_Reference_ID,AD_Table_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,1000069,'N','N','N',0,'N',36,'N','N','N','Y','8ab50616-ea21-4867-b1bf-3002ec728ffb','N','LBR_FiscalGroup_BPartner_UU','LBR_FiscalGroup_BPartner_UU','N',TO_DATE('2014-01-16 15:08:55','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-16 15:08:55','YYYY-MM-DD HH24:MI:SS'),0,'N','N',0,'N','N','N',1000021,10,1000004,0,'LBR')
;
...
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,1000071,'Y','N','N',0,'N',7,'N','N','N','Y','2a4158b5-7025-4dc6-ae26-7f6fa4142191','N','Updated','Date this record was updated','The Updated field indicates the date that this record was updated.','Updated','N',TO_DATE('2014-01-16 15:10:26','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-16 15:10:26','YYYY-MM-DD HH24:MI:SS'),0,'N','N',0,'N','N',607,16,1000004,0,'LBR')
;

-- Jan 16, 2014 3:10:32 PM BRST
ALTER TABLE LBR_FiscalGroup_BPartner ADD Updated DATE NOT NULL
;

-- Jan 16, 2014 3:10:59 PM BRST
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Help,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,AD_Client_ID,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,1000072,'Y','N','N',0,'N',22,'N','N','N','Y','e3bdab34-94b0-47d1-b080-16680fbfb05a','N','UpdatedBy','User who updated this records','The Updated By field indicates the user who updated this record.','Updated By','N',TO_DATE('2014-01-16 15:10:59','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2014-01-16 15:10:59','YYYY-MM-DD HH24:MI:SS'),0,'N','N',0,'N','N',608,18,110,1000004,0,'LBR')
;

-- Jan 16, 2014 3:11:04 PM BRST
UPDATE AD_Column SET FKConstraintName='UpdatedBy_LBRFiscalGroupBPartn', FKConstraintType='N',Updated=TO_DATE('2014-01-16 15:11:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=1000072
;

-- Jan 16, 2014 3:11:04 PM BRST
ALTER TABLE LBR_FiscalGroup_BPartner ADD UpdatedBy NUMBER(10) NOT NULL
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','LBR','The record is active in the system','Active','99397b05-5a45-48f0-b0a5-6bbe16a6a19c','N','Y',0,0,TO_DATE('2014-01-16 15:14:32','YYYY-MM-DD HH24:MI:SS'),0,TO_DATE('2014-01-16 15:14:32','YYYY-MM-DD HH24:MI:SS'),'Y',2,0,2,1000067)
;
...
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2014-01-16 15:16:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=1000047
;

-- Jan 16, 2014 3:16:32 PM BRST
UPDATE AD_Field SET NumLines=2,Updated=TO_DATE('2014-01-16 15:16:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=1000049
;

-- Jan 16, 2014 3:18:17 PM BRST
INSERT INTO AD_Menu (AD_Window_ID,AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,Name,Description,AD_Menu_UU,Action,IsActive,CreatedBy,Updated,Created,UpdatedBy,AD_Client_ID,AD_Org_ID) VALUES (1000004,1000006,'N','Y','N','LBR','Y','BP Fiscal Group','Maintain Business Partner Fiscal Groups','f5892bf4-25a9-4686-90c7-1e385fb35dfc','W','Y',0,TO_DATE('2014-01-16 15:18:17','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2014-01-16 15:18:17','YYYY-MM-DD HH24:MI:SS'),0,0,0)
;

-- Jan 16, 2014 3:18:17 PM BRST
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', SysDate, 0, SysDate, 0,t.AD_Tree_ID, 1000006, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1000006)
;
...
-- Jan 16, 2014 3:18:22 PM BRST
UPDATE AD_TreeNodeMM SET Parent_ID=278, SeqNo=7, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000006
;
...
-- Jan 16, 2014 3:18:31 PM BRST
UPDATE AD_TreeNodeMM SET Parent_ID=1000004, SeqNo=1, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=1000006
;
