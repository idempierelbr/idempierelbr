...
ALTER TABLE LBR_DocLine_COFINS ADD CalculationType VARCHAR2(3) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_COFINS ADD LBR_DocLine_COFINS_UU VARCHAR2(36) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_COFINS ADD LBR_COFST_CalcType VARCHAR2(3) DEFAULT NULL 
;
...
ALTER TABLE LBR_DocLine_COFINS ADD LBR_COF_TaxStatus VARCHAR2(2) DEFAULT NULL 
;
