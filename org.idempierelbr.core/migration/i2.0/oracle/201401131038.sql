...
ALTER TABLE LBR_NCM ADD Description NVARCHAR2(255) DEFAULT NULL 
;
...
ALTER TABLE LBR_NCM ADD LBR_NCM_UU NVARCHAR2(36) DEFAULT NULL 
;
...
ALTER TABLE LBR_NCM ADD Value NVARCHAR2(60) NOT NULL
;
