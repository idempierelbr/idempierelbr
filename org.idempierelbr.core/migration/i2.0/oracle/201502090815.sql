...
ALTER TABLE LBR_IBPTax ADD LBR_IBPTax_UU NVARCHAR2(36) DEFAULT NULL 
;
...
ALTER TABLE LBR_IBPTax ADD Code NVARCHAR2(20) DEFAULT NULL 
;
...
ALTER TABLE LBR_IBPTax ADD LBR_Exception NVARCHAR2(20) DEFAULT NULL 
;
...
ALTER TABLE LBR_IBPTax ADD Type NVARCHAR2(20) DEFAULT NULL 
;
...
ALTER TABLE LBR_IBPTax ADD Description NVARCHAR2(500) DEFAULT NULL 
;
...
ALTER TABLE LBR_IBPTax ADD LBR_IBPTaxKey NVARCHAR2(20) DEFAULT NULL 
;
...
ALTER TABLE LBR_IBPTax ADD VersionNo NVARCHAR2(20) DEFAULT NULL 
;
...
ALTER TABLE LBR_IBPTax ADD LBR_Source NVARCHAR2(50) DEFAULT NULL 
;
