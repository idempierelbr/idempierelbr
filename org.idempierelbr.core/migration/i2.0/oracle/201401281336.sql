...
ALTER TABLE LBR_Tax ADD Description VARCHAR2(255) DEFAULT NULL 
;
...
ALTER TABLE LBR_Tax ADD LBR_Tax_UU VARCHAR2(36) DEFAULT NULL 
;
...
ALTER TABLE LBR_TaxLine ADD LBR_TaxLine_UU VARCHAR2(36) DEFAULT NULL 
;
