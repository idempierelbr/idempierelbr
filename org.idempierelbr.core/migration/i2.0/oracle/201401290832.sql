...
ALTER TABLE LBR_NCMTax ADD LBR_NCMTax_UU VARCHAR2(36) DEFAULT NULL 
;
...
ALTER TABLE LBR_NCMTax ADD Description VARCHAR2(255) DEFAULT NULL 
;
...
ALTER TABLE LBR_ICMSMatrix ADD Description VARCHAR2(255) DEFAULT NULL 
;
...
ALTER TABLE LBR_ICMSMatrix ADD LBR_ICMSMatrix_UU VARCHAR2(36) DEFAULT NULL 
;
...
ALTER TABLE LBR_ISSMatrix ADD LBR_ISSMatrix_UU VARCHAR2(36) DEFAULT NULL 
;
