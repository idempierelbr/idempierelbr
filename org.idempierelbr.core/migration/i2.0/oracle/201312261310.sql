...
ALTER TABLE C_BPartner ADD LBR_BPTypeBR VARCHAR2(2)
;
...
ALTER TABLE C_BPartner ADD LBR_CNPJ VARCHAR2(14)
;
...
ALTER TABLE C_BPartner ADD LBR_CPF VARCHAR2(11) DEFAULT NULL 
;
...
ALTER TABLE C_BPartner ADD LBR_RG VARCHAR2(30) DEFAULT NULL 
;
...
ALTER TABLE C_BPartner ADD LBR_CCM VARCHAR2(30) DEFAULT NULL 
;
...
ALTER TABLE C_BPartner ADD LBR_Suframa VARCHAR2(30) DEFAULT NULL 
;
...
ALTER TABLE C_BPartner ADD LBR_IE VARCHAR2(30) DEFAULT NULL 
;
