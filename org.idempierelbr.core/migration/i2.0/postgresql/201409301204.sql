...
INSERT INTO AD_Form (AccessLevel,Classname,AD_Form_ID,Help,IsBetaFunctionality,AD_Form_UU,Description,Name,AD_Org_ID,UpdatedBy,CreatedBy,Updated,IsActive,AD_Client_ID,EntityType,Created) VALUES ('1','org.idempierelbr.nfe.apps.form.WNFFromXMLGen',1000001,'Generate Brazilian Fiscal Invoice from NF-e XML.','N','bfe627a3-79f9-4274-9609-32b800a8623c','Select NF-e XML and generate Brazilian Fiscal Invoice','Generate NF From XML (manual)',0,0,0,TO_TIMESTAMP('2014-09-14 11:14:06','YYYY-MM-DD HH24:MI:SS'),'Y',0,'LBR',TO_TIMESTAMP('2014-09-14 11:14:06','YYYY-MM-DD HH24:MI:SS'))
;

-- 14/09/2014 11h17min50s BRT
INSERT INTO AD_Menu (AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,EntityType,IsCentrallyMaintained,Name,Description,AD_Menu_UU,"action",IsActive,CreatedBy,Updated,UpdatedBy,AD_Client_ID,AD_Org_ID,AD_Form_ID,Created) VALUES (1000035,'N','N','N','LBR','Y','Generate NF From XML (manual)','Select NF-e XML and generate Brazilian Fiscal Invoice','db843d11-38af-4372-b022-4b22b6525153','X','Y',0,TO_TIMESTAMP('2014-09-14 11:17:50','YYYY-MM-DD HH24:MI:SS'),0,0,0,1000001,TO_TIMESTAMP('2014-09-14 11:17:50','YYYY-MM-DD HH24:MI:SS'))
;

-- 14/09/2014 11h17min50s BRT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 0, statement_timestamp(), 0,t.AD_Tree_ID, 1000035, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=1000035)
;
