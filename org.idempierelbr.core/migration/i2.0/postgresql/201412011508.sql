...
-- 01/12/2014 10h43min5s BRST
UPDATE AD_TreeNodeMM SET Parent_ID=1000016, SeqNo=8, Updated=statement_timestamp() WHERE AD_Tree_ID=10 AND Node_ID=800000
;
