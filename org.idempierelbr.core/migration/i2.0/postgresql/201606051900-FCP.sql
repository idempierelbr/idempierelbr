...
UPDATE AD_Column SET VFormat=NULL,Updated=TO_TIMESTAMP('2016-06-05 19:39:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=1000114
;

-- 05/06/2016 19h40min7s BRT
INSERT INTO LBR_TaxName (AD_Client_ID,AD_Org_ID,Created,CreatedBy,Description,LBR_HasWithHold,IsActive,LBR_TaxName_ID,LBR_TaxName_UU,Name,LBR_TaxType,LBR_WithHoldFrequency,Updated,UpdatedBy,WithHoldThreshold) VALUES (0,0,TO_TIMESTAMP('2016-06-05 19:40:07','YYYY-MM-DD HH24:MI:SS'),0,'Indicador da Alíquota do Fundo de Combate a Pobreza - ESPECIAL ** Não Alterar **','N','Y',1000016,'34dbaf6e-4b7f-4d94-a3e6-e6b376452348','FCP','P','M',TO_TIMESTAMP('2016-06-05 19:40:07','YYYY-MM-DD HH24:MI:SS'),0,0)
;
