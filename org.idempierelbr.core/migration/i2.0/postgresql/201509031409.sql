...
INSERT INTO AD_Element (ColumnName,AD_Element_ID,Name,Description,PrintName,AD_Element_UU,Updated,AD_Org_ID,CreatedBy,UpdatedBy,IsActive,AD_Client_ID,EntityType,Created) VALUES ('LBR_OwnDateDelivered',800135,'Declarant Date Delivered','Date Delivered from the point of view of the declarant','Declarant Date Delivered','f802e99f-1ff7-4527-a65f-39a969b1e0d2',TO_TIMESTAMP('2015-09-03 13:57:26','YYYY-MM-DD HH24:MI:SS'),0,0,0,'Y',0,'LBR',TO_TIMESTAMP('2015-09-03 13:57:26','YYYY-MM-DD HH24:MI:SS'))
;

-- Sep 3, 2015 2:02:02 PM BRT
INSERT INTO AD_Column (SeqNoSelection,IsSyncDatabase,Version,AD_Column_ID,IsMandatory,IsTranslated,IsIdentifier,SeqNo,IsParent,FieldLength,IsSelectionColumn,IsKey,IsAutocomplete,IsAllowLogging,AD_Column_UU,IsUpdateable,ColumnName,Description,Name,IsAllowCopy,Updated,CreatedBy,IsActive,Created,UpdatedBy,IsToolbarButton,IsAlwaysUpdateable,IsEncrypted,IsSecure,AD_Element_ID,AD_Reference_ID,AD_Table_ID,AD_Client_ID,AD_Org_ID,EntityType) VALUES (0,'N',0,800602,'N','N','N',0,'N',7,'N','N','N','Y','ddb966f6-2ace-4a3e-b213-bee37b32afac','Y','LBR_OwnDateDelivered','Date Delivered from the point of view of the declarant','Declarant Date Delivered','Y',TO_TIMESTAMP('2015-09-03 14:02:01','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_TIMESTAMP('2015-09-03 14:02:01','YYYY-MM-DD HH24:MI:SS'),0,'N','N','N','N',800135,15,1000033,0,0,'LBR')
;

-- Sep 3, 2015 2:02:10 PM BRT
ALTER TABLE LBR_NotaFiscal ADD COLUMN LBR_OwnDateDelivered TIMESTAMP DEFAULT NULL 
;

-- Sep 3, 2015 2:02:47 PM BRT
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,SeqNo,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Description,Name,AD_Field_UU,IsDisplayed,IsFieldOnly,UpdatedBy,CreatedBy,Updated,IsActive,IsDisplayedGrid,SeqNoGrid,AD_Client_ID,ColumnSpan,AD_Column_ID,AD_Org_ID,Created) VALUES ('N',1000068,7,'N','N',470,'Y',800155,'N','LBR','Date Delivered from the point of view of the declarant','Declarant Date Delivered','41f1b5c3-4e96-433d-bed2-ccff5fe9afe4','Y','N',0,0,TO_TIMESTAMP('2015-09-03 14:02:43','YYYY-MM-DD HH24:MI:SS'),'Y','Y',440,0,2,800602,0,TO_TIMESTAMP('2015-09-03 14:02:43','YYYY-MM-DD HH24:MI:SS'))
;
