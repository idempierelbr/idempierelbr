 ...
 * Uses Mockito static and construction mocking, but requires the iDempiere
 * OSGi container + DB because {@code MLBRDigitalCertificate} loads its
 * table id from {@code AD_Table} during static init.
 */
@ExtendWith(MockitoExtension.class)
class DigitalCertificateUtilIT extends AbstractLBRTestCase {
	...
	private static InputStream resource(String name) {
		return DigitalCertificateUtilIT.class.getResourceAsStream("/resources/test/" + name);
	}
