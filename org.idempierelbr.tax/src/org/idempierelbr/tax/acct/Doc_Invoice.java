					...
					for (int t = 0; t < m_taxes.length; t++) {
						...
						if (tax.get_ValueAsInt("LBR_TaxGroup_ID") == MLBRTax.getTaxGroupID(MLBRTax.TAX_GROUP_ICMSST_NAME))	{
							...
							// VENDA
								...
								// Não incluído no preço do produto
								else if (!icms.isLBR_ICMSST_IsTaxIncluded()) {
									//
								}
							}
