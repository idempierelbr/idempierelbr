...
/** Generated Model for LBR_MDFeUnload
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_LBR_MDFeUnload extends PO implements I_LBR_MDFeUnload, I_Persistent 
{
    ...
    public X_LBR_MDFeUnload (Properties ctx, int LBR_MDFeUnload_ID, String trxName)
    {
      super (ctx, LBR_MDFeUnload_ID, trxName);
      /** if (LBR_MDFeUnload_ID == 0)
        {
			setC_City_ID (0);
			setC_Region_ID (0);
    ...
    /** Load Constructor */
    public X_LBR_MDFeUnload (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LBR_MDFeUnload[")
	...
	public void setLBR_MDFeUnload_ID (int LBR_MDFeUnload_ID)
	{
		if (LBR_MDFeUnload_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_LBR_MDFeUnload_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_LBR_MDFeUnload_ID, Integer.valueOf(LBR_MDFeUnload_ID));
	}
