...
/**
 * Process to send NFS-e/RPS lot
 *
 * @author pablo 21/06/2016 pblobp@gmail.com
 */
public class ProcSendNFSLot extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		return "Lote consultado com sucesso!";
	} // doIt
	...
	public static void sendRPS(Properties ctx, int LBR_NFSLot_ID, String trxName)
		...
		if (lot.getNFSConfig() == null)
			throw new AdempiereException(
					"Nenhuma configuração definida no Tipo de Documento da NFS-e/RPS");
		...
		if (nfsModel != null) {
			...
			// process 
			// nfsInstance.sendRPSLot(lot);
			nfsInstance.sendNFSe(lot.getLines()[0].getNFS());
		}
	}
}
